    ...
    <div class="relative group/item" v-for="attribute in attributes" :key="attribute.id">
      ...
      <template v-if="attribute.data_type !== 'checkbox'">
        ...
        >
          ...
          <div class="flex items-center gap-0.5 transition-opacity duration-200 flex-shrink-0 can-hover:opacity-0 can-hover:group-hover/item:opacity-100 focus-within:opacity-100">
            <button
